...
<div class="row">
  <div class="col-md-6">
    <div class="well">
	  ...
	  <a class="btn btn-primary" href="data_model_overview/bundle">MAEC Bundle »</a>
    </div>
  	<div class="well">
      ...
      <a class="btn btn-primary" href="data_model_overview/package">MAEC Package »</a>
    </div>
  	<div class="well">
	  ...
	  <a class="btn btn-primary" href="data_model_overview/container">MAEC Container »</a>
    </div>
  </div>
</div>