...
<div class="row">
  <div class="col-md-6">
    <div class="well">
      ...
      <a class="btn btn-primary" href="malware_analysis">Go Â»</a>
    </div>
	<div class="well">
      ...
      <a class="btn btn-primary" href="cyber_threat_analysis">Go Â»</a>
    </div>
	<div class="well">
      ...
      <a class="btn btn-primary" href="intrusion_detection">Go Â»</a>
    </div>
  </div>
  <div class="col-md-6">
    <div class="well">
